/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ed0c8bd91a0af3d7c89e077e77c68d2d)
// Runtime types generated with workerd@1.20250617.0 2025-07-04 
declare namespace Cloudflare {
	interface Env {
		ENV: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRETE: string;
		AUTHJS_TOKEN_SECRET: string;
		FRONTEND_URL: string;
		OPENROUTER_API_KEY: string;
		ALARM_EXAMPLE: DurableObjectNamespace<import("./src/index").AlarmExample>;
		EMAIL_SCHEDULER: DurableObjectNamespace<import("./src/index").EmailSchedulerDO>;
	}
}
